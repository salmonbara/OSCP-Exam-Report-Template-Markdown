## 4.3 Target #3 – 192.168.0.0
### 4.3.1 Initial Access - {Vuln type}
...
### 4.3.3 Initial Access – {Vuln type}
...
### 4.3.4 Privilege Escalation - {Privesc type}

{Step by step}

### 4.3.5 Post Exploitation
